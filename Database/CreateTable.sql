...
DROP TABLE IF EXISTS CloudResource CASCADE;
DROP TABLE IF EXISTS Vulnerability CASCADE;
DROP TABLE IF EXISTS SecurityScan CASCADE;
DROP TABLE IF EXISTS Report CASCADE;
DROP TABLE IF EXISTS RemedialPlan CASCADE;
DROP TABLE IF EXISTS ProgressTracker CASCADE;
